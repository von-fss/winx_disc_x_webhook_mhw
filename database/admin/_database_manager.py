...
teste = cur.execute("select * from last_posts where published = 0")

# teste = cur.execute("select * from last_posts where x_id = 1900593019989966853")
# cur.execute("update last_posts set published = 0 where x_id = 1900593019989966853")
# con.commit()
